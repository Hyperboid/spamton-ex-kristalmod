...
function Spamscape:init(x,y)
    ...
    self.background:addChild(Sprite("backgrounds/spamscape_background", 198, 0)).debug_select = false
    self.background:addChild(Sprite("backgrounds/spamscape_background", (198*2), 0)).debug_select = false
    self.background:setScale(2)
    self.midground = Sprite("backgrounds/spamscape_midground")
    self.midground:addChild(Sprite("backgrounds/spamscape_midground", 198, 0)).debug_select = false
    self.midground:addChild(Sprite("backgrounds/spamscape_midground", (198*2), 0)).debug_select = false
    self.midground:setScale(2)
    self.foreground = Sprite("backgrounds/spamscape_foreground")
    self.foreground:addChild(Sprite("backgrounds/spamscape_foreground", 198, 0)).debug_select = false
    self.foreground:addChild(Sprite("backgrounds/spamscape_foreground", (198*2), 0)).debug_select = false
    self.foreground:setScale(2)
    self.tracklines = {}
    for i, v in ipairs({163,252,334}) do
        self.tracklines[i] = TrackLine(0, v)
        self.tracklines[i].debug_select = false
